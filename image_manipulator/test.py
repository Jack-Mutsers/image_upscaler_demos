...
def BrightnessContrast(brightness=0):
    ...
    brightness = cv2.getTrackbarPos('Brightness', 'Effect')
      
    contrast = cv2.getTrackbarPos('Contrast', 'Effect')
...
if __name__ == '__main__':
    ...
    original = cv2.imread("D:\\Users\\jmuts\\Afbeeldingen\\upscale results\\original.png")
    ...
    cv2.createTrackbar('Brightness', 'Effect', 255, 2 * 255, BrightnessContrast) 
      
    # Contrast range -127 to 127
    cv2.createTrackbar('Contrast', 'Effect', 127, 2 * 127, BrightnessContrast)  
